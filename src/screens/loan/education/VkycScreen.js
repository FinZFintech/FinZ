...
const styles = StyleSheet.create({
  ...
  instructions: { backgroundColor: 'rgba(74,237,196,0.08)', padding: 14, borderRadius: 10, marginBottom: 20 },
  ...
  pendingBanner: { backgroundColor: 'rgba(74,237,196,0.08)', padding: 14, borderRadius: 8, marginBottom: 16 },
