...
const styles = StyleSheet.create({
  ...
  selectedOption: { borderColor: COLORS.primary, backgroundColor: '#E8F5E9' },
  ...
  pendingBanner: { backgroundColor: '#E3F2FD', padding: 12, borderRadius: 8, marginBottom: 12 },
  pendingText: { fontSize: 13, color: COLORS.info, lineHeight: 20 },
  btn: { marginTop: 12 },
  incomeGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  incomeItem: {
    width: '47%', backgroundColor: '#F5F7FA', padding: 12, borderRadius: 10, alignItems: 'center',
  },
  ...
  warningCard: { alignItems: 'center', backgroundColor: '#FFF8E1' },
