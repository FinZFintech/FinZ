...
const styles = StyleSheet.create({
  ...
  selectedOption: { borderColor: COLORS.teal, backgroundColor: '#E8F8F7' },
  ...
  pendingBanner: { backgroundColor: '#E8F8F7', padding: 12, borderRadius: 8, marginBottom: 12 },
  pendingText: { fontSize: 13, color: COLORS.teal, lineHeight: 20 },
  btn: { marginTop: 12 },
  incomeGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  incomeItem: {
    width: '47%', backgroundColor: '#E8F8F7', padding: 12, borderRadius: 10, alignItems: 'center',
  },
