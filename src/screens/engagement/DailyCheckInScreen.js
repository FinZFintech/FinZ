...
const styles = StyleSheet.create({
  ...
  checkedBadge: { backgroundColor: '#EEEDF5', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 20 },
  ...
  correctOption: { borderColor: COLORS.success, backgroundColor: '#EEEDF5' },
