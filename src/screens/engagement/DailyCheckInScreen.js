...
const styles = StyleSheet.create({
  ...
  dayCircle: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#F0EDF5', alignItems: 'center', justifyContent: 'center' },
  ...
  checkedBadge: { backgroundColor: '#E8F8F7', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 20 },
  ...
  correctOption: { borderColor: COLORS.teal, backgroundColor: '#E8F8F7' },
