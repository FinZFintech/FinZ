...
const OffersScreen = ({ navigation }) => {
  ...
  const loadOffers = async () => {
    try {
      ...
      setOffers([
        { id: '1', title: 'Zero Processing Fee', description: 'Apply for education loan this month and get zero processing fee!', validTill: '2026-03-31', color: '#E8F5E9' },
        { id: '2', title: 'Reduced Interest Rate', description: 'Special 11% p.a. interest rate for select institutes.', validTill: '2026-04-15', color: '#E3F2FD' },
