...
export const getStatusColor = (status) => {
  const statusColors = {
    draft: '#9E9E9E',
    institute_verified: '#2196F3',
    pan_verified: '#2196F3',
    credit_check_passed: '#4CAF50',
    credit_check_failed: '#F44336',
    kyc_completed: '#4CAF50',
    kyc_failed: '#F44336',
    selfie_verified: '#4CAF50',
    bank_verified: '#4CAF50',
    income_verified: '#4CAF50',
    fully_eligible: '#2E7D32',
